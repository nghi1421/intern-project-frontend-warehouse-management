...
function createStaff() {
  ...
  const isValidPhoneNumber = phoneNumber.value.match(
  ...
  if (v$.value.$invalid) {
    ...
    if (isValidPhoneNumber) {
      ...
      store.dispatch("createStaff", data).then((response) => {
            ...
            >
              ...
              <div class="mt-2">
                <form
                  ...
                  class="grid grid-cols-6 gap-3 bg-white"
                >
